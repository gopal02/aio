...
#define DP501_P0_ADDR (0xB0) /* (0x30) */
#define DP501_P1_ADDR (0xB2) /* (0x32) */
#define DP501_P2_ADDR (0xB4) /* (0x34) */
#define DP501_P3_ADDR (0xB6) /* (0x36) */
...
struct dp501 {
	...
	int (*edp_init)(struct i2c_client *client, int resume);
